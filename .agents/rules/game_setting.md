...
All towns in the game are connected by roads that DO NOT enter the forest, but they are also connected by paths and signposts that cut through the forest
_in_ the forest. There is even a town forest itself, however it may only be reached by heading to the deepest part of the forest and may not be reached by normal roads.
...
1. A stable where horses may be kept
1. A healers shop where the player can be healed of injuries
1. A quest board, for quests presented by nobls and their commesurate rewards


This is not safe society. Brigands rove the roads looking for travelers to steal from.
